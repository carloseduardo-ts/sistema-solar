...
void main()
{
	...
	vec3 EarthColor = texture(Texture, UV + Time * vec2(0.008, 0.00)).rgb;
	vec3 CloudsColor = texture(CloudsTexture, UV + Time * vec2(0.0099, 0.00)).rgb;
	...
	vec3 DiffuseReflection = Lambertian * LightIntensity * SurfaceColor;
